      ...
      <div className="container overflow-hidden">
        <div className="flex flex-row justify-between w-full gap-20">
          <div className="space-y-4 w-11/12">
            ...
            <p className="text-lg md:text-2xl font-medium pt-4 tracking-wide" style={{ lineHeight: "1.75" }}>
          ...
          <div className="card bg-base-100 w-2/6 h-fit shadow-xl hidden xl:block border-2 border-black border-r-8 border-b-8">
